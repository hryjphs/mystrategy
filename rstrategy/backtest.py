# -*- coding: utf-8 -*-
"""
Created on Wed Jun 19 18:57:25 2019
...
import json
import os
from strategy import rStrategy
...
if __name__ == '__main__':
    ...
    mp.addLine(line=chartLog[['upper', 'middle', 'lower']].reset_index(), colors={"upper": "green","middle": "red",'lower':'blue'}, pos=0)
    mp.addLine(line=chartLog[['fastMa','mediumMa','slowMa']].reset_index(), colors={'fastMa':"green",'mediumMa':"red",'slowMa':"blue"}, pos=1)
    mp.resample()
    mp.show()